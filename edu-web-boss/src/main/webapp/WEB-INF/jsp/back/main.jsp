...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-header">
        <div class="layui-main">
            <!-- logo -->
            <a href="/">
                <img src="${ctx}/static/back/images/logo.png" alt="">
            </a>
            <!-- 水平导航 -->
            <ul class="layui-nav" style="position: absolute; top: 0; right: 0; background: none;">
                <li class="layui-nav-item">
                    <a href="http://www.baidu.com" target="_blank">访问官网</a>
                </li>
                <li class="layui-nav-item">
                    <a href="javascript:;">
                        admin
...
<script type="text/javascript">
    ...
    var menuList = [
        {id: 1, pid: 0, name: '主页', url: '${ctx}/back/user/'},
        {id: 2, pid: 0, name: '百度', url: 'http://www.baidu.com'}
    ]
    layui.use(['cms'], function () {
        var cms = layui.cms('left-nav', 'top-tab');
        cms.addNav(menuList, 0, 'id', 'pid', 'name', 'url');
